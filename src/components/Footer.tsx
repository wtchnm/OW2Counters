export function Footer() {
	return (
		<footer class='px-16 py-8 text-center text-sm text-white md:py-2'>
			...
			intended solely for informational and entertainment purposes. No copyright
			infringement is intended | <a href='https://github.com/wtchnm'>GitHub</a>
		</footer>
	)
}
